...
import { useCreateSpeaker, useSpeaker, useUpdateSpeaker } from '@/features/speakers/hooks'
import { ArrowLeft, Mail, Phone, Twitter } from 'lucide-react'
import { useState } from 'react'
import { type Speaker } from '@/features/speakers/types'
import { Skeleton } from '@/components/ui/skeleton'

export const Route = createFileRoute('/internal/speakers/$speakerId')({
    component: SpeakerPage,
})

function SpeakerPage() {
    const { speakerId } = useParams({ from: '/internal/speakers/$speakerId' })
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="flex items-center gap-4">
                <button
                    onClick={() => navigate({ to: '/internal/speakers' })}
